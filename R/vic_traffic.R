...
traffic.hex <-  h2o.uploadFile(localH2O, path = "Data/vic_trafficdata.csv")
summary(traffic.hex)
...
write.csv(vol.preds, file = "Pred/vic_vol_preds.csv", row.names=FALSE)
...
write.csv(spd.preds, file = "Pred/vic_speed_preds.csv", row.names=FALSE)
