...
load(file="../coll_framework_val/data/vic_study_vars")
...
writeRaster(brt.preds, filename="/home/casey/Research/Github/coll_framework_cal/output/egk_preds_brt_500.tif", format="GTiff", overwrite=TRUE, NAflag=-9999, datatype='FLT4S') #Write out prediction map in tif format
