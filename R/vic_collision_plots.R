...
tiff('figs/vic_occ.tif', pointsize = 11, compression = "lzw", res=300, width = 900, height = 900)
...
tiff('figs/vic_tvol.tif', pointsize = 11, compression = "lzw", res=300, width = 900, height = 900)
...
tiff('figs/vic_tspd.tif', pointsize = 11, compression = "lzw", res=300, width = 900, height = 900)
